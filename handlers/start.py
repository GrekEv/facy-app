...
def get_main_keyboard() -> InlineKeyboardMarkup:
    ...
    builder.row(
        InlineKeyboardButton(
            text="–û—Ç–∫———Ç— –ø—––ª–æ–∂–µ–Ω––µ",
            web_app=WebAppInfo(url=webapp_url)
        )
    )
    builder.row(
        InlineKeyboardButton(text="––æ–π ––∞–ª–∞–Ω—", callback_data="balance"),
        InlineKeyboardButton(text="–—Ç–∞—Ç–——Ç––∫–∞", callback_data="stats")
    )
    builder.row(
        InlineKeyboardButton(text="–—É–ø–—Ç— –ø–æ––Ω—Ç—", callback_data="buy_points"),
    )
    builder.row(
        InlineKeyboardButton(text="––æ–º–æ——", callback_data="help")
    )
